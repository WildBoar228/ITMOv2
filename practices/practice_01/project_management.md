...
- Что проверили и исправили сами: ответ структурирован, план привязан к конкретным бизнес-правилам из Context Pack. Диаграмма Ганта содержит даты начиная с момента заполнения файла, оставил их, т.к. не могу заменить на что-либо осмысленное.
